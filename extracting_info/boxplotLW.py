...
data = pd.read_csv("loopdelay_LW.csv") # Reading loop delay csv file for two Laptops communication through a router
data = data.drop(['0','Unnamed: 1'], axis = 1)
...
data.to_csv("results_LW.csv", index=False) # report analysis in a csv file
print(percent)

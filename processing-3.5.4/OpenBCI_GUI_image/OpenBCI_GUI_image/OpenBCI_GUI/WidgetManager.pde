...
W_FreqSound w_FreqSound;
W_brainSong w_brainSong;
W_image_focus w_image_focus;
...
void setupWidgets(PApplet _this, ArrayList<Widget> w){
  ...
  addWidget(w_networking, w);
   ...
   // Adjusted focus of image based on brain response
  w_image_focus = new W_image_focus(_this);
  w_image_focus.setTitle("Image Focus");
  addWidget(w_image_focus, w);
  ...
  //Cyton/Synthetic Widget_4, Ganglion/Playback Widget_5
  w_FreqSound = new W_FreqSound(_this);
  w_FreqSound.setTitle("FreqSound");
  addWidget(w_FreqSound, w);
  // println("  setupWidgets band power -- " + millis());
  ...
  //Cyton/Synthetic Widget_5, Ganglion/Playback Widget_6
  w_brainSong = new W_brainSong(_this);
  w_brainSong.setTitle("Brain Song");
  addWidget(w_brainSong, w);
  // println("  setupWidgets head plot -- " + millis());

      ...
      println("recieving mode");
        ...
        if (filter==0) {
          if (this.protocol.equals("LSL")) {
              ...
              println("max channel ",recieved_Data);
              println("max power",dataTorecieve[0]);
    ...
    void sendPowerBandData() {
        ...
        if (this.filter==0 || this.filter==1) {
            ...
            // UDP
                ...
                //print("power band ",dataToSend[0] ,dataToSend[1] ,dataToSend[2] ,dataToSend[3]  ,dataToSend[4]  ,dataToSend[5]  ,dataToSend[6]  ,dataToSend[7] ,dataToSend[8]  );
                ...
                // Add timestamp to LSL Stream
                outlet_data.push_chunk(dataToSend, System.currentTimeMillis());
                print("time stamp ", System.currentTimeMillis());
            } else if (this.protocol.equals("Serial")) {
                for (int i=0;i<numChan;i++) {
                    serialMessage = "[" + (i+1) + ","; //clear message
                    for (int j=0;j<numBandPower;j++) {

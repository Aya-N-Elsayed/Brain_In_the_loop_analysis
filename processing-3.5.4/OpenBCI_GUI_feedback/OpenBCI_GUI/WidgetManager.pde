...
W_visual_altering W_visual_altering;
W_colorfreq_band W_colorfreq_band;
...
void setupWidgets(PApplet _this, ArrayList<Widget> w){
    ...
    //Widget_visual_altering
   W_visual_altering = new W_visual_altering(_this);
   W_visual_altering.setTitle("Visual Altering");
    addWidget(W_visual_altering, w);
 
    //Widget colorfreq_band
   W_colorfreq_band = new W_colorfreq_band(_this);
   W_colorfreq_band.setTitle("colorfreq_Band");
    addWidget(W_colorfreq_band, w);

...
class SoftwareSettings {
    ...
    String[] nwDataTypesArray = {"None", "TimeSeries", "FFT", "EMG", "BandPower", "Accel/Aux", "Focus" ,"Receive","Pulse", "SSVEP"};
    ...
    String[] arHorizScaleArray = {"Sync", "1 se c", "3 sec", "5 sec", "10 sec", "20 sec"};
    ...
    private final String kJSONKeyReceive = "Receive";
